	...
	<div class="folder top">
		...
		<div class="folder-content form">
			<input type="button" class="button" value="Tạo mới" style="width:180px;" onClick="parent.location='<?php echo Yii::app()->createUrl('language/create')?>'"/>
			<input type="button" class="button" value="Xóa" style="width:180px;" onClick="parent.location='<?php echo Yii::app()->createUrl('language/delete')?>'"/>
			<input type="button" class="button" value="Export" style="width:180px;" onClick="parent.location='<?php echo Yii::app()->createUrl('language/export')?>'"/>
			<input type="button" class="button" value="Import" style="width:180px;" onClick="parent.location='<?php echo Yii::app()->createUrl('language/import')?>'"/>
		<?php $form=$this->beginWidget('CActiveForm', array('method'=>'post','id'=>'form-edit-language','action'=>Yii::app()->createUrl('language/edit'))); ?>
		<!--begin box search-->
