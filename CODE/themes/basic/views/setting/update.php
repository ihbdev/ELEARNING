	...
	<div class="folder top">
		...
		<div class="folder-content form">
			<div>
                <input type="button" class="button" value="Thêm tham số cấu hình" style="width:180px;" onClick="parent.location='<?php echo Yii::app()->createUrl('setting/create')?>'"/>
                <input type="button" class="button" value="Danh sách tham số cấu hình" style="width:180px;" onClick="parent.location='<?php echo Yii::app()->createUrl('setting')?>'"/>
