	...
	<div class="folder top">
		...
		<div>
            	<input type="button" class="button" value="Thêm mới" style="width:180px;" onClick="parent.location='<?php echo Yii::app()->createUrl('setting/create')?>'"/>
  				...
  				'columns'=>array(
					...
					array(
    					...
    					(
    						...
    						(
            					'label'=>'Copy bài viết',
            					'imageUrl'=>Yii::app()->request->getBaseUrl(true).'/images/copy.gif',
            					'url'=>'Yii::app()->createUrl("setting/copy", array("id"=>$data->id))',
        					),
        				),
						'headerHtmlOptions'=>array('width'=>'10%','class'=>'table-title'),
					),    				
