 						<div class="text-question">
                            <div class="text-title">
                            	...
                            	<div id="<?php echo $css_id;?>">
                            		...
                            		<a class="i16 i16-trashgray" href="<?php echo Yii::app()->createUrl('languageSkill/removeQuestion',array('question_id'=>$question->id))?>"></a>
                            	</div>
                            	<div id="<?php echo $css_id.'_form';?>" style="display: none;">
                            		...
                            		<a class="i16 i16-checkblue" href="<?php echo Yii::app()->createUrl('languageSkill/updateQuestion',array('id'=>$question->id))?>"></a>
                            ...
                            <div class="text-check">
                            	...
                            	<div id="<?php echo $css_id?>" class="<?php if($list_answer[$index]) echo 'active'?>"><label><?php echo ($index+1)?>) <?php echo $option?></label>
                            		<a class="i16 i16-statustext"></a>
                            		<a class="i16 i16-trashgray" href="<?php echo Yii::app()->createUrl('languageSkill/removeQuestion',array('question_id'=>$question->id,'index_choice'=>$index))?>"></a>
                            	</div>
                            	...
                            	<?php endforeach;?>
                            	<div class="row"><a class="i16 i16-addgreen add_choice_form" id="<?php echo $question->id?>" href="<?php echo Yii::app()->createUrl('languageSkill/updateQuestion',array('id'=>$question->id))?>"></a></div>
                            </div>                            
                        </div><!--text-question-->