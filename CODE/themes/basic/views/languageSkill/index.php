	...
	<div class="folder top">
		...
		<div class="folder-header">
			<h1><?php echo Language::t('List Language Skill tests')?></h1>
			<div class="header-menu">
				<ul>
					<li class="ex-show"><a class="activities-icon" href=""><span><?php echo Language::t('List Language Skill tests')?></span></a></li>
				</ul>
			</div>
		</div>
		<!--end title-->
		<div class="folder-content">
            <div>
            	<input type="button" class="button" value="<?php echo Language::t('Add new Language Skill test')?>" style="width:180px;" onClick="parent.location='<?php echo Yii::app()->createUrl('languageSkill/create')?>'"/>
                ...
                <div class="fl" style="width:480px;">
                    <ul>
                        <li>
                         	...
                         	'model'=>$model,
                         	'attribute'=>'title',
							'url'=>array('languageSkill/suggestTitle'),
							'htmlOptions'=>array(
								'style'=>'width:230px;',
								),
						)); ?>	
