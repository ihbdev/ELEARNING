...
--
-- Host: localhost
-- Generation Time: Jun 23, 2012 at 09:37 AM
...
(7, 12, 'vi', 'english-7', 'English', 0, 1, 1, '', '{"description":"","metadesc":""}', 1, 1340349813),
(8, 12, 'vi', 'french', 'French', 0, 1, 2, '', '{"description":"","metadesc":""}', 1, 1340349818),
(9, 12, 'vi', 'germany', 'Germany', 0, 1, 3, '', '{"description":"","metadesc":""}', 1, 1340349826);
...
(98, 'en', 'List Language Skill tests', '', '', '', 'languageSkill', 'index'),
(99, 'en', 'Add new Language Skill test', '', '', '', 'languageSkill', 'index'),
(100, 'en', 'Status', '', '', '', 'languageSkill', 'index'),
(101, 'en', 'Change status', '', '', '', 'languageSkill', 'index'),
(102, 'en', 'Tools', '', '', '', 'languageSkill', 'index'),
(103, 'en', 'Are you sure that you want to delete the test?', '', '', '', 'languageSkill', 'index'),
(104, 'en', 'Delete succcessfully', '', '', '', 'languageSkill', 'index'),
(105, 'en', 'Edit', '', '', '', 'languageSkill', 'index'),
(106, 'en', 'Delete', '', '', '', 'languageSkill', 'index'),
(107, 'en', 'Copy', '', '', '', 'languageSkill', 'index'),
(108, 'en', 'tests', '', '', '', 'languageSkill', 'index'),
(109, 'en', 'Create Language Skill Test', '', '', '', 'languageSkill', 'create'),
(110, 'en', 'Language Skills', '', '', '', 'languageSkill', 'create'),
(111, 'en', 'Language', '', '', '', 'languageSkill', 'create'),
(112, 'en', 'Language Skills Title', '', '', '', 'languageSkill', 'create'),
(113, 'en', 'Title', '', '', '', 'languageSkill', 'create'),
(114, 'en', 'Description', '', '', '', 'languageSkill', 'create'),
(115, 'en', 'Post Q&A Text ', '', '', '', 'languageSkill', 'create'),
(116, 'en', 'Material', '', '', '', 'languageSkill', 'create'),
(117, 'en', 'Question', '', '', '', 'languageSkill', 'create'),
(118, 'en', 'File', '', '', '', 'languageSkill', 'create'),
(119, 'en', 'Add question', '', '', '', 'languageSkill', 'create'),
(120, 'en', 'List test language skills', '', '', '', 'knowledgeSkill', 'index'),
(121, 'en', 'List test Knowledge Skills', '', '', '', 'knowledgeSkill', 'index'),
(122, 'en', 'Add new Knowledge Skill Test', '', '', '', 'knowledgeSkill', 'index'),
(123, 'en', 'Search', '', '', '', 'knowledgeSkill', 'index'),
(124, 'en', 'Tools', '', '', '', 'knowledgeSkill', 'index'),
(125, 'en', 'Test guide', '', '', '', 'markingUpSkill', 'create'),
(126, 'en', 'List test Marking-up', '', '', '', 'codingSkill', 'index'),
(127, 'en', 'Add new test marking-up final', '', '', '', 'codingSkill', 'index'),
(128, 'en', 'Add new test marking-up level', '', '', '', 'codingSkill', 'index'),
(129, 'en', 'Status', '', '', '', 'codingSkill', 'index'),
(130, 'en', 'Change status', '', '', '', 'codingSkill', 'index'),
(131, 'en', 'Tools', '', '', '', 'codingSkill', 'index'),
(132, 'en', 'Are you sure that you want to delete the test?', '', '', '', 'codingSkill', 'index'),
(133, 'en', 'Delete succcessfully', '', '', '', 'codingSkill', 'index'),
(134, 'en', 'Edit', '', '', '', 'codingSkill', 'index'),
(135, 'en', 'Delete', '', '', '', 'codingSkill', 'index'),
(136, 'en', 'Copy', '', '', '', 'codingSkill', 'index'),
(137, 'en', 'tests', '', '', '', 'codingSkill', 'index'),
(138, 'en', 'Coding', '', '', '', 'codingSkill', 'create'),
(139, 'en', 'Add new test coding detail', '', '', '', 'codingSkill', 'create'),
(140, 'en', 'List tests', '', '', '', 'codingSkill', 'create'),
(141, 'en', 'Test info', '', '', '', 'codingSkill', 'create'),
(142, 'en', 'Title', '', '', '', 'codingSkill', 'create'),
(143, 'en', 'Description', '', '', '', 'codingSkill', 'create'),
(144, 'en', 'Material for test', '', '', '', 'codingSkill', 'create'),
(145, 'en', 'Material', '', '', '', 'codingSkill', 'create'),
(146, 'en', 'List questions', '', '', '', 'codingSkill', 'create'),
(147, 'en', 'Question', '', '', '', 'codingSkill', 'create'),
(148, 'en', 'File', '', '', '', 'codingSkill', 'create'),
(149, 'en', 'Add question', '', '', '', 'codingSkill', 'create'),
(150, 'en', 'Create', '', '', '', 'codingSkill', 'create');
...
INSERT INTO `tbl_menu` (`id`, `type`, `name`, `parent_id`, `order_view`, `status`, `created_by`, `created_date`, `other`) VALUES
(2, 1, 'Language Skills', 0, 2, 0, 1, 1339390275, ''),
(5, 1, 'Knowledge Skills', 0, 3, 0, 1, 1339390312, ''),
(11, 1, 'Coding', 0, 4, 0, 1, 1339390416, ''),
(12, 1, 'Profile/Branch Coding', 11, 1, 0, 1, 1339390432, ''),
(14, 1, 'Training', 12, 2, 0, 1, 1339390473, ''),
(20, 1, 'Validation Test', 12, 3, 0, 1, 1339390702, ''),
(21, 1, 'Datail Coding', 11, 2, 0, 1, 1339390735, ''),
(23, 1, 'Training', 21, 2, 0, 1, 1339390758, ''),
(31, 1, 'Validation Test', 21, 3, 0, 1, 1339391071, ''),
(35, 1, 'Marking up', 0, 3, 0, 1, 1339391169, ''),
(37, 1, 'Test Level', 35, 2, 0, 1, 1339391195, ''),
(38, 1, 'Final Test', 35, 3, 0, 1, 1339391209, ''),
(48, 1, 'Guide', 0, 11, 0, 1, 1339391365, ''),
(53, 2, 'Test', 0, 1, 0, 1, 1340341794, '{"modified":"{\\"1340349357\\":\\"1\\"}","controller":"languageSkill","action":"index","description":"","params":""}'),
(54, 2, 'Language', 53, 1, 0, 1, 1340341809, '{"modified":"{\\"1340349416\\":\\"1\\"}","controller":"languageSkill","action":"index","description":"","params":""}'),
(55, 2, 'Knowledge', 53, 2, 0, 1, 1340341816, '{"modified":"{\\"1340349428\\":\\"1\\"}","controller":"knowledgeSkill","action":"index","description":"","params":""}'),
(56, 2, 'Marking-up', 53, 3, 0, 1, 1340341830, '{"modified":"{\\"1340349460\\":\\"1\\"}","controller":"markingUpSkill","action":"index","description":"","params":""}'),
(57, 2, 'Coding', 53, 4, 0, 1, 1340341850, '{"modified":"{\\"1340349466\\":\\"1\\"}","controller":"codingSkill","action":"index","description":"","params":""}'),
(58, 2, 'Exam', 0, 2, 0, 1, 1340341860, '{"modified":"{\\"1340349484\\":\\"1\\"}","controller":"exam","action":"index","description":"","params":""}'),
(59, 2, 'Result', 0, 3, 0, 1, 1340341865, '{"modified":"{\\"1340349489\\":\\"1\\"}","controller":"result","action":"index","description":"","params":""}'),
(63, 2, 'Manager', 54, 1, 0, 1, 1340349600, '{"controller":"languageSkill","action":"index","description":"","params":""}'),
(64, 2, 'Create', 54, 2, 0, 1, 1340349617, '{"controller":"languageSkill","action":"create","description":"","params":""}'),
(65, 2, 'Manager', 55, 1, 0, 1, 1340349642, '{"controller":"knowledgeSkill","action":"index","description":"","params":""}'),
(66, 2, 'Create', 55, 2, 0, 1, 1340349661, '{"controller":"knowledgeSkill","action":"create","description":"","params":""}'),
(67, 2, 'Manager', 56, 1, 0, 1, 1340349677, '{"controller":"markingUpSkill","action":"index","description":"","params":""}'),
(68, 2, 'Create', 56, 2, 0, 1, 1340349695, '{"controller":"markingUpSkill","action":"create","description":"","params":""}'),
(69, 2, 'Manager', 57, 1, 0, 1, 1340349714, '{"controller":"codingSkill","action":"index","description":"","params":""}'),
(70, 2, 'Create', 57, 2, 0, 1, 1340349725, '{"controller":"codingSkill","action":"create","description":"","params":""}'),
(71, 2, 'Manager', 58, 1, 0, 1, 1340349740, '{"controller":"exam","action":"index","description":"","params":""}'),
(72, 2, 'Create', 58, 2, 0, 1, 1340349751, '{"controller":"exam","action":"create","description":"","params":""}');
...
(4, 'E00004', '068bf8c42edece5daa08c9ec0dc0b317', '4f570d19da3d07.31748483', 1, 'admin@grizzlyclassifieds.com', 2, '{"status":0,"firstname":"Le","lastname":"Thanh","register_date":1340249927,"last_visit_date":1340249927}'),
